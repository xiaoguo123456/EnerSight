...
| # | 事项 | 文档 |
| --- | --- | --- |
| 1 | 环境指数 92 分数学上不可达（云量 35% 时上限 89.2 分） | [07 §1.6](./07-metrics.md) |
| 2 | 苏州光伏站发电量在两个页面相差 2.6 倍 | [07 §八](./07-metrics.md) |
| 3 | AI 模型选型（境内备案模型 vs Claude） | [08 §2.2](./08-ai-design.md) |
| 4 | 地图页图例与激活图层不对应 | [04 §四](./04-data-specification.md) |
| 5 | 「我的」页面需求与设计稿 | [01 §二](./01-prd.md) |
