...
见 [docs/README.md](docs/README.md) 末尾。其中两项必须先答复：

1. **环境指数 92 分数学上不可达** —— 云量 35% 时理论上限 89.2 分，
   算法得 82 分。设计稿标注的输入与输出不自洽，不是调参能解决的。
2. **同一站点发电量在两个页面差 2.6 倍** —— 站点卡 2,400 kWh，
   AI 报告 6,320 kWh，必须定以哪个为准。
