...
import './index.scss'
export function DataFreshness({ time, label = '气象数据', timeLabel = '', staleMinutes = 120, refreshing, failed, onRefresh }: {
  time?: string | null; label?: string; timeLabel?: string; staleMinutes?: number; refreshing?: boolean; failed?: boolean; onRefresh?: () => void
}) {
