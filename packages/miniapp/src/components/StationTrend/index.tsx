...
export function StationTrend({ stationId, type, initial, version = 0, exportName, compact = false }: { stationId: string; type: string; initial: TrendSeries | null; version?: number; exportName?: string; compact?: boolean }) {
