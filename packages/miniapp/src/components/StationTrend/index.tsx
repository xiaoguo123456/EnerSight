...
const OPTIONS = [{ value: 'radiation', label: '辐射' }, { value: 'wind_speed', label: '风速' }, { value: 'cloud_cover', label: '云量' }]
...
export function StationTrend({ stationId, type, initial, version = 0 }: { stationId: string; type: string; initial: TrendSeries | null; version?: number }) {
  ...
  return <View>
    ...
    <View style={{ fontSize: '11px', color: '#718096', marginTop: '8px' }}>时间轴为电站当地时间</View>
