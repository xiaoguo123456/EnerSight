...
const CONTENT: Record<string, { title: string; sections: [string, string][] }> = {
  ...
  privacy: { title: '数据使用说明', sections: [
    ...
    ['自建场站信息', '你添加的场站名称、类型、坐标、装机容量、设备参数与限电规则保存在服务端，仅本账号可见，用于该场站的气象预测、预警、报告与卫星影像归档。删除场站会一并删除它的预警、发电记录、分析报告与预测留档；在「我的」页“删除我的数据”可一次删除本账号全部自建电站及上述记录，删除后不可恢复。'],
  ...
  terms: { title: '用户服务协议', sections: [
    ...
    ['自建电站与数据', '你填写的电站信息仅本账号可见，用于该电站的预测、预警与报告。你可以随时删除单个电站，或在「我的」页删除全部数据，删除后不可恢复。'],
