...
export const layersApi = {
  get: (layer: LayerType, bbox: BBox, zoom: number, cloudMode: 'auto' | 'satellite' = 'auto') => {
    ...
    const key = [model, layer, cloudMode, zoom, bbox.west, bbox.south, bbox.east, bbox.north].join(':')
