...
轮毂高度风速：Open-Meteo 直接给 10 / 80 / 100 / 120 / 200 m 各层风速（GFS 没有 200 m），
按对数风廓线在相邻两层之间插值到轮毂高度。风切变随大气稳定度昼夜变化近 3 倍（白天 α≈0.1、
...
LEVEL_COLUMNS: dict[float, str] = {
    ...
    # ECMWF IFS / ICON 原生层。没有它时轮毂高于 120 m 只能按 100–120 m 斜率外推，
    # 夜间 100 m 以上风速几乎不再增加，外推会把 140–160 m 轮毂电量高估一到两成
    200.0: "wind_speed_200m",
}
